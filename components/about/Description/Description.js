...
const Description = () => {
  const content = [
    {
      subtitle: 'The Future is Bright with Solar Power',
      title: ' Unlock the Potential of Renewable Energy',
    ...
    {
      subtitle: 'Powering Your Life with Solar Energy',
      title: " Harness the Sun's Energy for a Brighter Future",
    ...
    },
    {
      ...
      title: ' A Sustainable Solution for a Greener Tomorrow',
    ...
    {
      title: 'Save Money and Save the Planet with Solar Energy',
