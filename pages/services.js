    ...
    },
    {
      ...
      info: (
        <div>
          {' '}
          <p>
            The design phase of a solar power system installation involves
            several key steps to ensure the system is properly sized and
            configured to meet the energy needs of the site where it will be
            installed.
          </p>
          <ul>
            <li className={styles.margin}>
              <FaCheckCircle className={styles.check__icon} /> Site assessment:
              The first step is to assess the site where the solar power system
              will be installed. This includes analyzing factors such as the
              location, shading, orientation, and available space for the
              panels.
            </li>
            <li className={styles.margin}>
              <FaCheckCircle className={styles.check__icon} /> Energy
              consumption analysis: The next step is to conduct an energy
              consumption analysis to determine the amount of electricity that
              will be needed to meet the energy needs of the site. This includes
              analyzing data such as the electricity consumption patterns, the
              type of equipment and appliances that will be powered by the solar
              system, and the number of hours of sunlight the site receives.
            </li>
            <li className={styles.margin}>
              <FaCheckCircle className={styles.check__icon} /> System sizing:
              Based on the energy consumption analysis, the solar power system
              can be properly sized. This includes determining the number of
              solar panels that will be needed, the capacity of the inverter
              that will be used to convert the DC power generated by the panels
              into AC power, and the type and size of the battery system that
              will be used to store excess energy.
            </li>
            <li className={styles.margin}>
              <FaCheckCircle className={styles.check__icon} /> Equipment
              selection: Once the system has been sized, the equipment for the
              solar power system can be selected. This includes selecting the
              type and size of the solar panels, the inverter, and the battery
              system.
            </li>
            <li className={styles.margin}>
              ...
              maximize energy production, and designing the electrical wiring
              and interconnection of the system.
            </li>
            <li className={styles.margin}>
              <FaCheckCircle className={styles.check__icon} /> Final document
              and permits: The final step in the design phase is to prepare
              detailed documentation of the solar power system design, including
              plans, specifications, and calculations. This documentation will
              be used to obtain the necessary permits and approvals from local
              authorities before the installation can begin.
            </li>
          </ul>
        </div>
      ),
